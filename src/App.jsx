...
const App = () => {
  ...
  const account = "stmkparisappdev"
  const sasToken = "si=get-services-images&sv=2022-11-02&sr=c&sig=PDtstiidMh33XOv1axF3gVEkNl16m4rSC%2FR6OoRCAjs%3D"
  const containerName = "images-services"
  ...
  // console.log("Hello World", sasToken);
